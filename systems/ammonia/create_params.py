...
DATA_DIR = f"{os.getenv('POOL')}/projects/evidential/systems/ammonia/data"
MODEL_DIR = f"{os.getenv('POOL')}/projects/evidential/systems/ammonia/models"
PARAMS_DIR = f"{os.getenv('POOL')}/projects/evidential/systems/ammonia/params/inbox"
